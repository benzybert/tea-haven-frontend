...
const UnauthenticatedNav = () => (
  <div>
    <Link to={ROUTES.LOGIN} className="text-indigo-600 hover:text-indigo-800 mr-4">
      Sign In
    </Link>
    <Link to={ROUTES.REGISTER} className="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700">
      Register
    </Link>
  </div>
);
